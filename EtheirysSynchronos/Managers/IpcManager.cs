...
namespace EtheirysSynchronos.Managers
{
    ...
    public class IpcManager : IDisposable
    {
        ...
        public string PenumbraCreateTemporaryCollection(string characterName)
        {
            ...
            var ret = _penumbraCreateTemporaryCollection.InvokeFunc("EtheirysSynchronos", characterName, true);
            return ret.Item2;
        }
        ...
        public void PenumbraSetTemporaryMods(string collectionName, Dictionary<string, string> modPaths, string manipulationData)
        {
            ...
            var ret = _penumbraSetTemporaryMod.InvokeFunc("EtheirysSynchronos", collectionName, modPaths, manipulationData, 0);
        }
