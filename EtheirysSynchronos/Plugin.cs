...
using EtheirysSynchronos.FileCacheDB;
...
namespace EtheirysSynchronos
{
    public sealed class Plugin : IDalamudPlugin
    {
            ...
            Framework framework, ObjectTable objectTable, ClientState clientState)
        {
            ...
            _localization = new Dalamud.Localization("EtheirysSynchronos.Localization.", "", true);
            _localization.SetupWithLangCode("en");

            _windowSystem = new WindowSystem("EtheirysSynchronos");
        ...
        public string Name => "Etheirys Synchronos";
        public void Dispose()
        {
        ...
        private void DalamudUtilOnLogIn()
        {
            ...
            {
                HelpMessage = "Opens the Etheirys Synchronos UI"
            });
