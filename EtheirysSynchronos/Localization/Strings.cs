...
namespace EtheirysSynchronos.Localization
{
    public static class Strings
    {
        public class ToSStrings
        {
            ...
            public readonly string Paragraph6 = Loc.Localize("Paragraph6",
                "This service is provided as-is. In case of abuse, contact darkarchon#4313 on Discord or join the Etheirys Synchronos Discord. " +
