...
namespace EtheirysSynchronos.UI
{
    ...
    public class SettingsUi : Window, IDisposable
    {
        ...
        public SettingsUi(WindowSystem windowSystem,
            UiShared uiShared, Configuration configuration, ApiController apiController) : base("Etheirys Synchronos Settings")
        {
        ...
        private void DrawBlockedTransfers()
        {
            UiShared.ColorTextWrapped("Files that you attempted to upload or download that were forbidden to be transferred by their creators will appear here. " +
                                 ...
                                 "Ask your paired friend to send you the mod in question through other means, acquire the mod yourself or pester the mod creator to allow it to be sent over Etheirys.",
