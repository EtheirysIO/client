...
namespace EtheirysSynchronos.UI
{
    public class CompactUi : Window, IDisposable
    {
        ...
        public CompactUi(WindowSystem windowSystem,
            UiShared uiShared, Configuration configuration, ApiController apiController) : base("Etheirys Synchronos " + Assembly.GetExecutingAssembly().GetName().Version + "###EtheirysSynchronosMainUI")
        {
        ...
        private void DrawServerStatus()
        {
            ...
            var textSize = _apiController.OnlineUsers <= 1 ? ImGui.CalcTextSize("User Online") : ImGui.CalcTextSize("Users Online");
        ...
        private void DrawUIDHeader()
        {
            ...
            UiShared.AttachToolTip("Open the Etheirys Synchronos Settings");
        ...
        private string GetServerError()
        {
            ...
            {
                ServerState.Disconnected => "You are currently disconnected from the Etheirys Synchronos server.",
