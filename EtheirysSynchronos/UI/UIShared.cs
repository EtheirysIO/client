...
namespace EtheirysSynchronos.UI
{
    public class UiShared : IDisposable
    {
        ...
        public bool DrawOtherPluginState()
        {
            ...
            {
                ImGui.TextColored(ImGuiColors.DalamudRed, "You need to install both Penumbra and Glamourer and keep them up to date to use Etheirys Synchronos.");
                return false;
            }
        ...
        public void PrintServerState(bool isIntroUi = false)
        {
            ...
            if (!isIntroUi)
            {
                if (_apiController.ServerAlive)
                {
                    ...
                    ImGui.SameLine();
                    if (_apiController.OnlineUsers <= 1)
                        ImGui.Text("User Online");
                    else
        ...
        {
            ColorTextWrapped("Note: The cache folder should be somewhere close to root (i.e. C:\\EtheirysCache) in a new empty folder. DO NOT point this to your game folder. DO NOT point this to your Penumbra folder.", ImGuiColors.DalamudYellow);
            ...
            {
                _fileDialogManager.OpenFolderDialog("Pick Etheirys Synchronos Cache Folder", (success, path) =>
                {
                    if (!success) return;
            ...
            {
                ColorTextWrapped("Your selected directory has files inside that are not Etheirys related. Use an empty directory or a previous Etheirys cache directory only.", ImGuiColors.DalamudRed);
            }
